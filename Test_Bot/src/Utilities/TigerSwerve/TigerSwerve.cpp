 ...
 */
TigerSwerve::TigerSwerve(std::unordered_map<std::string,
                         std::shared_ptr<can::TalonSRX>>& talons)
{
    xAxis = 0;
    yAxis = 0;
    rotAxis = 0;
    ...
    modules->insert(std::make_pair(Global_Constants::Swerve_Drive::FLMODULEID, SwerveModule(talons.find(Global_Constants::Swerve_Drive::FLDRIVEID)->second, talons.find(Global_Constants::Swerve_Drive::FLROTID)->second)));
    modules->insert(std::make_pair(Global_Constants::Swerve_Drive::FRMODULEID, SwerveModule(talons.find(Global_Constants::Swerve_Drive::FRDRIVEID)->second, talons.find(Global_Constants::Swerve_Drive::FRROTID)->second)));
    modules->insert(std::make_pair(Global_Constants::Swerve_Drive::BLMODULEID, SwerveModule(talons.find(Global_Constants::Swerve_Drive::BLDRIVEID)->second, talons.find(Global_Constants::Swerve_Drive::BLROTID)->second)));
    modules->insert(std::make_pair(Global_Constants::Swerve_Drive::BRMODULEID, SwerveModule(talons.find(Global_Constants::Swerve_Drive::BRDRIVEID)->second, talons.find(Global_Constants::Swerve_Drive::BRROTID)->second)));
}
...
void TigerSwerve::Drive(double xSpeed, double ySpeed, double rotSpeed, double headingOffset)
{
    ...
    modules->find(Global_Constants::Swerve_Drive::FLMODULEID)->second.Set(flWheelSpeed, flWheelAngle, true);
    modules->find(Global_Constants::Swerve_Drive::FRMODULEID)->second.Set(frWheelSpeed, frWheelAngle, true);
    modules->find(Global_Constants::Swerve_Drive::BLMODULEID)->second.Set(blWheelSpeed, blWheelAngle, true);
    modules->find(Global_Constants::Swerve_Drive::BRMODULEID)->second.Set(brWheelSpeed, brWheelAngle, true);
}
 ...
 */
void TigerSwerve::SwerveInverseKinematics(Translation2D &velocity, double yawRate, double &wheelSpeedFR, double &wheelSpeedFL, double &wheelSpeedBR, double &wheelSpeedBL, Rotation2D &wheelAngleFL, Rotation2D &wheelAngleFR, Rotation2D &wheelAngleBL, Rotation2D &wheelAngleBR)
{

    double A = velocity.getX() - yawRate * (Global_Constants::Swerve_Drive::kDRIVEBASE_LENGTH / 2.0);
    double B = velocity.getX() + yawRate * (Global_Constants::Swerve_Drive::kDRIVEBASE_LENGTH / 2.0);
    double C = velocity.getY() - yawRate * (Global_Constants::Swerve_Drive::kDRIVEBASE_WIDTH / 2.0);
    double D = velocity.getY() + yawRate * (Global_Constants::Swerve_Drive::kDRIVEBASE_WIDTH / 2.0);
 ...
 */
RigidTransform2D::Delta TigerSwerve::SwerveForwardKinematics(Rotation2D& flAngle, RigidTransform2D::Delta& flVelocity, Rotation2D& frAngle, RigidTransform2D::Delta& frVelocity, Rotation2D& blAngle, RigidTransform2D::Delta& blVelocity, Rotation2D& brAngle, RigidTransform2D::Delta& brVelocity)
{
    ...
    double yawRate1 = (VxBack - VxFront) / Global_Constants::Swerve_Drive::kDRIVEBASE_LENGTH;
    double yawRate2 = (VyRight - VyLeft) / Global_Constants::Swerve_Drive::kDRIVEBASE_WIDTH;
    double yawRate = (yawRate1 + yawRate2) / 2.0;

    double Vxc1 = VxBack - yawRate * Global_Constants::Swerve_Drive::kDRIVEBASE_LENGTH / 2.0;
    double Vxc2 = VxFront + yawRate * Global_Constants::Swerve_Drive::kDRIVEBASE_LENGTH / 2.0;
    double Vyc1 = VyRight - yawRate * Global_Constants::Swerve_Drive::kDRIVEBASE_WIDTH / 2.0;
    double Vyc2 = VyLeft + yawRate * Global_Constants::Swerve_Drive::kDRIVEBASE_WIDTH / 2.0;
