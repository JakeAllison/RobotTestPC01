...
public:
    ...
    Translation2D
    translateBy(const Translation2D &other) const;
    Translation2D
    rotateBy(const Rotation2D &rotation) const;

    virtual Translation2D
    interpolate(const Translation2D &other, double x) const;
    Translation2D
    extrapolate(const Translation2D &other, double x) const;
